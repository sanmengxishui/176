...
namespace JPTCG
{
    public partial class mainWin : Form
    {
        ...
        public TcpseriveComMgr A162Seriver;//huang20171027
        ...
        public mainWin()
        {
            ...
            A162Seriver = new TcpseriveComMgr();//huang20171027
            A162Seriver.TcpseriveComMgr_Add("A162");//huang20171027

            SeqMgr = new MachineSeq(this, motionMgr, RotMgr, specMgr, BarCMgr, camera1, camera2, AMgrMod1, AMgrMod2, A162Seriver);
        ...
        private void mainWin_Load(object sender, EventArgs e)
        {
            ...
            A162Seriver.TcpseriveComMgr_Load(mchSettingsFilePath);//huang20171027
        ...
        private void LoadMchSettings()
        {
            ...
            //Para.Robotablebool
            FileOperation.ReadData(mchSettingsFilePath, "Machine", "Robotablebool", ref strread);//huang20171028
            if (strread != "0")
            {
                if (bool.Parse(strread))
                    Robotablecheck.Checked = true;
                else
                    Robotablecheck.Checked = false;

                Para.Robotablebool = Robotablecheck.Checked;
        ...
        private void SaveMchSettings()
        {
            ...
            FileOperation.SaveData(mchSettingsFilePath, "Machine", "Robotablebool", Para.Robotablebool.ToString());//huang20171028
        ...
        {
            A162Seriver.TcpseriveComMgr_Win();
        }

        private void Robotablecheck_CheckedChanged(object sender, EventArgs e)
        {
            Para.Robotablebool = Robotablecheck.Checked;
            if (Para.Robotablebool)
            {
