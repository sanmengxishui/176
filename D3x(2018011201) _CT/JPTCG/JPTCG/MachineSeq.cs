...
namespace JPTCG
{
    public class StationModule
    {
        ...
        public string A176CurMod1 = "";//huang20171027
        public string A176CurMod2 = "";//huang20171027
        public string A162CurMod1 = "0";//huang20171027
        public string A162CurMod2 = "0";//huang20171027
        public string Mod1BinCode = "";//huang20171027
        public string Mod2BinCode = "";//huang20171027
        public string Mod1ErrorCode = "";//huang20171027
        public string Mod2ErrorCode = "";//huang20171027
    }
    ...
    public class MachineSeq
    {
        ...
        TcpseriveComMgr A162Seriver;//huang20171027
        ...
        bool A176PutCG;//清除上料标志//huang20171028
        bool A162start;//清除启动标志//huang20171028
        bool A162started;////清除启动完成标志//huang20171028
        bool MachineIsStop = true;//设备是否在运行huang20171027
        bool MachineIsPause = false;//设备是否暂停huang20171027
        bool MachineIsError = false;//设备是否报警huang20171027
        ...
        public MachineSeq(mainWin myMain, DeltaMotionMgr myMotion, RotaryMotion myRotMotion, SpectManager mySpecMgr, BarcodeMgr myBarcode, HalconVision myCam1, HalconVision myCam2,
                        AppleTestSWCom myAComMod1, AppleTestSWCom myAComMod2, TcpseriveComMgr a16seriver)
        {
            ...
            A162Seriver = a16seriver;//huang20171027
            //
            ...
            A162Seriver.TcpserList[0].EventCommu += SetA176_Mes;//huang20171027
        ...
        private void OnThreadStoppedError()
        {
            ...
            if (Para.EnableBuzzer)
            {
                ...
                {
                    myMotionMgr.WriteIOOut((ushort)OutputIOlist.Buzzer, true);
        ...
        public int GetDarkModule1()    //xsm
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (i == 0)
                    mainWnd.UpdateMod1Chart(stationStatus[myIdx].DarkManage_1[i], stationStatus[myIdx].DarkRefMod1, false);
            }
            //avg && stb
        ...
        public int GetDarkModule2()    //xsm
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (i == 0)
                    mainWnd.UpdateMod2Chart(stationStatus[myIdx].DarkManage_2[i], stationStatus[myIdx].DarkRefMod2, false);
            }
            //avg && stb
            double avg = 0, std = 0, sumstdev = 0;
            bool darkerror = false;
        ...
        public void StartAuto()
        {
            ...
            MachineIsStop = false;//huang20171027
            MachineIsPause = false;//huang20171027
            MachineIsError = false;//huang20170227

        }

        public void StopAuto()
        {
            MachineIsStop = true;//huang20171027
            MachineIsPause = false;//huang20171027
            //safetySeq.Stop();
            mainSeq.Stop();
            camSeq.Stop();
        ...
        {
            MachineIsPause = true;//huang20171027
            //safetySeq.Pause();
            mainSeq.Pause();
            camSeq.Pause();
            testSeq.Pause();
        ...
        public void ResetAll()
        {
            ...
            for (int i = 0; i < _Num_Of_Station; i++)
            {
                ...
                stationStatus[i].A162CurMod1 = "0";//huang20171027
                stationStatus[i].A162CurMod2 = "0";
                stationStatus[i].A176CurMod1 = "";
                stationStatus[i].A176CurMod2 = "";
                stationStatus[i].Mod1BinCode = "";//huang20171027
                stationStatus[i].Mod2BinCode = "";//huang20171027
                stationStatus[i].Mod1ErrorCode = "";//huang20171027
                stationStatus[i].Mod2ErrorCode = "";//huang20171027
            }

            A176PutCG = false;//清除上料标志//huang20171028
            A162start = false;//清除启动标志//huang20171028
            A162started = false;//清除启动完成标志//huang20171028
            MachineIsStop = true;//huang20171027
            MachineIsPause = false;//huang20171027
            MachineIsError = false;//huang20170227
        ...
        private int UnloadUnit()
        {
            ...
            else
            {
                ...
                if (!Para.EnbStation4Unloading)
                {
                    if (stationStatus[rtIdx].isUnitLoad1)
                    {
                        ...
                        {
                            mainWnd.UpdateMod1TestResult(0, rtIdx);
                            stationStatus[rtIdx].A162CurMod1 = "1";//表示产品OK
                            //if (stationStatus[rtIdx].Mod1BinCode == "A")
                            //{
                            //    stationStatus[rtIdx].A162CurMod1 = "5";//表示产品为BInA产品
                            //}
                            //if (stationStatus[rtIdx].Mod1BinCode == "B")
                            //{
                            //    stationStatus[rtIdx].A162CurMod1 = "6";//表示产品为BInB产品
                            //}
                        }    
                        else
                        {
                            mainWnd.UpdateMod1TestResult(1, rtIdx);
                            if (stationStatus[rtIdx].Mod1ErrorCode == "UOP")
                            {
                                stationStatus[rtIdx].A162CurMod1 = "3";//表示产品最终NG
                            }
                            else
                            {
                                stationStatus[rtIdx].A162CurMod1 = "3";//表示产品需要复测试
                                //stationStatus[rtIdx].A162CurMod1 = "2";//表示产品需要复测试
                            }    
                    ...
                    if (stationStatus[rtIdx].isUnitLoad2)
                    {
                        ...
                        { 
                            mainWnd.UpdateMod2TestResult(0, rtIdx);
                            stationStatus[rtIdx].A162CurMod2 = "1";//表示产品OK
                            //if (stationStatus[rtIdx].Mod2BinCode == "A")
                            //{
                            //    stationStatus[rtIdx].A162CurMod2 = "5";//表示产品为BInA产品
                            //}
                            //if (stationStatus[rtIdx].Mod2BinCode == "B")
                            //{
                            //    stationStatus[rtIdx].A162CurMod2 = "6";//表示产品为BInB产品
                            //}
                        }
                        else
                        {
                            mainWnd.UpdateMod2TestResult(1, rtIdx);
                            if (stationStatus[rtIdx].Mod2ErrorCode == "UOP")
                            {
                                stationStatus[rtIdx].A162CurMod2 = "3";//表示产品最终NG
                            }
                            else
                            {
                                stationStatus[rtIdx].A162CurMod2 = "3";//表示产品需要复测试
                                //stationStatus[rtIdx].A162CurMod2 = "2";//表示产品需要复测试
                            }
                        }
                    ...
                    stationStatus[rtIdx].Mod1BinCode = "";//huang20171027
                    stationStatus[rtIdx].Mod2BinCode = "";//huang20171027
                    stationStatus[rtIdx].Mod1ErrorCode = "";//huang20171027
                    stationStatus[rtIdx].Mod2ErrorCode = "";//huang20171027
            ...
            //stationStatus[rtIdx].A162CurMod1 = "3";//表示产品OK
            //stationStatus[rtIdx].A162CurMod2 = "1";//表示产品OK
            A176PutCG = true;//huang20171027
            return 0;
        }
        ...
        private int WaitUnitLoaded()
        {
            ...
            if (Para.Robotablebool)//huang20171027
            {
                A162started = true;//huang20171027
                if (A162start)
                {
        ...
        private int ScanBarCode()
        {
            ...
            {
                stationStatus[rtIdx].isUnitLoad1 = false;
                if (Para.Robotablebool)
                {
                    stationStatus[rtIdx].A162CurMod1 = "4";//读码失败//huang20171027
                    stationStatus[rtIdx].A162CurMod2 = "4";//读码失败//huang20171027 
                    stationStatus[rtIdx].isUnitLoad1 = false;
                    stationStatus[rtIdx].isUnitLoad2 = false;
                    Thread.Sleep(50);
                    Application.DoEvents();
        ...
        private int RotaryIndexing()
        {
            ...
            A162started = false;//huang20171027
        ...
        {
            MachineIsError = true;//huang20170227
            MachineIsStop = true;//huang20171027
        ...
        private int InspectMod1Unit()
        {
            ...
            LabelFor140Means: myMotionMgr.WriteIOOut((ushort)OutputIOlist.Cam1Light, true);
                ...
                if (!stationStatus[RotaryIdxAtCam].mod1VisResult.Found)
                {
                    if (Para.Robotablebool)//huang20171110
                    {
                        stationStatus[RotaryIdxAtCam].isUnitLoad1 = false;
                        stationStatus[RotaryIdxAtCam].A162CurMod1 = "4";//视觉检测失败
                        Thread.Sleep(50);
                        Application.DoEvents();
                        cam1InspSeq.JumpIndex(1);
                        return 99; //To Jump Index
                    }
                    else
                        return -2;
                ...
                if (Para.IsWhiteDark)
                {
                    string ImagePath = "G:\\BlackAndWhiteDotImage";
        ...
        private int InspectMod2Unit()
        {
            ...
            if (stationStatus[RotaryIdxAtCam].isUnitLoad2)
            {
                ...
                int exp1 = 0, exp2 = 0;
                double means1 = 0, means2 = 0;
            LabelFor140Means: myMotionMgr.WriteIOOut((ushort)OutputIOlist.Cam2Light, true);
                ...
                if (!stationStatus[RotaryIdxAtCam].mod2VisResult.Found)
                {
                    if (Para.Robotablebool)//huang20171110
                    {
                        ...
                        stationStatus[RotaryIdxAtCam].A162CurMod2 = "4";//视觉检测失败
                        Thread.Sleep(50);
                        Application.DoEvents();
                        cam2InspSeq.JumpIndex(1);
                        return 99; //To Jump Index
                    }
                    else
                        return -4;
        ...
        private int UploadDataToMacMini()
        {
            ...
            if (Para.EnableCGHost)
            {
                ...
                if (stationStatus[myIdx].isUnitLoad1)
                {
                    ...
                    AComMod1.SendStartTest(1 + (myIdx * 2), stationStatus[myIdx].Unit1Barcode, Para.LightSourceType, "CAS_" + Para.Spectrometer1SN);//20170211
                    ...
                    stationStatus[myIdx].Mod1BinCode = AComMod1.bin_Code.Substring(0,1);//huang20171110
                    stationStatus[myIdx].Mod1ErrorCode = AComMod1.errorString.Substring(0,3);//huang20171110
            ...
            if (Para.EnableCGHost)
            {
                if (stationStatus[myIdx].isUnitLoad2)
                {
                    ...
                    AComMod2.SendStartTest(2 + (myIdx * 2), stationStatus[myIdx].Unit2Barcode, Para.LightSourceType, "CAS_" + Para.Spectrometer2SN);//20170211
                    ...
                    stationStatus[myIdx].Mod2BinCode = AComMod2.bin_Code.Substring(0, 1);//huang20171110
                    stationStatus[myIdx].Mod2ErrorCode = AComMod2.errorString.Substring(0,3);//huang20171110
        ...
        {
            if (!Para.Robotablebool)// 如果没有使用Robot那么就直接回复A162stopping
            {
                A162Seriver.TcpserList[0].SendMessage("A162Stopping");
                return;
            }
            ...
            else
            {
                try
                {
                        ...
                        if (!MachineIsPause)
                        {
                            switch (strrlist[0] + ";" + strrlist[strrlist.Length - 1])
                            {
                                case "compelet;end"://取料NG
                                    //A162started = false;//清除启动完成标志//huang20171028
                                    stationStatus[rtIdx].A176CurMod1 = strrlist[1];
                                    stationStatus[rtIdx].A176CurMod2 = strrlist[2];
                                    if (A176PutCG)//告诉A176是否可以开始上料了
                                    {
                                        setstrRo = "compeleted;" + stationStatus[rtIdx].A162CurMod1 + ";" + stationStatus[rtIdx].A162CurMod2 + ";" + Para.CurrentRotaryIndex.ToString() + ";end";
                                        mainWnd.WriteOperationinformation("RobotConnectOK");
                                        //A176PutCG = false;//清除上料标志//huang20171028
                                    }
                                    else
                                    {
                                ...
                                case "start;end"://启动机台
                                    ...
                                    if (A162started)//等待启动
                                    {
                                        ...
                                        if (!A162start)
                                        {
                                            ...
                                            mainWnd.WriteOperationinformation("RobotStartOK");
                                        }
                                        else
                                        {
                                    ...
                                    break;
                                case "A162CurrectMod;end":
                                    string currect = "";//当前上料工位情况,0表示两个工位都没有料，1表示只有1工位有料，2表示只有2工位有料，3表示两个工位都有料
                                    bool leftbool = myMotionMgr.ReadIOIn((ushort)InputIOlist.LeftSensor);
                                    bool rightbool = myMotionMgr.ReadIOIn((ushort)InputIOlist.RightSensor);
                                    if (leftbool && rightbool)//左右都感应到料
                                        currect = "3";
                                    else if (leftbool && !rightbool)//只有左工位有料
                                        currect = "1";
                                    else if (!leftbool && rightbool)//只有右工位有料
                                        currect = "2";
                                    else if (!leftbool && !rightbool)//两个工位都有料
                                        currect = "0";
                                    else
                                    {
                                        setstrRo = "error";//读取错误
                                    ...
                                    setstrRo = "CurrectMod;" + currect + ";" + Para.CurrentRotaryIndex.ToString() + ";end";
                                    break;
                                case "EndLot;end":
                                    setstrRo = "EndLot;" + Para.EndLot + ";end";
                                    break;
                                case "AbleEndLot;end":
                                    if (bool.Parse(strrlist[1]))
                                    {
                                        Para.EndLot = true;
                                        mainWnd.dis_EndLot();   
                                    }
                                    ...
                                    setstrRo = "AbleEndLot;" + Para.EndLot + ";end";
                                    break;
                                case"Vacuum;end":
                                    if (strrlist[1] == "1")
                                    {
                                        switch (Para.CurrentRotaryIndex)
                                        { 
                                            case 0:
                                                myMotionMgr.WriteIOOut((ushort)OutputIOlist.RI1Vac1, true);
                                                break;
                                    ...
                                    setstrRo = "Vacuum;" + strrlist[1] + ";end";
                                    break;
                                default:
                                    setstrRo = "CurrectModNG";
                                    break;
                            }
                        }
                        else
                        {
                            setstrRo = "A162Pausing";
                            //if (MachineIsError)
                            //{
                            //    setstrRo = "A162ErrorPausing";                             
                            //}
                            //else
                            //{
                            //    setstrRo = "A162Pausing";
                    ...
                    {
                        setstrRo = "A162Stopping";

                        //if (MachineIsError)
                        //{
                        //    setstrRo = "A162ErrorStopping";
                        //}
                        //else
                        //{
                        //    setstrRo = "A162Stopping";
                    ...
                    //A176PutCG = false;//清除上料标志//huang20171028
                    //A162start = false;//清除启动标志//huang20171028
                    A162Seriver.TcpserList[0].SendMessage(setstrRo);
                }
                catch
                {
                }
