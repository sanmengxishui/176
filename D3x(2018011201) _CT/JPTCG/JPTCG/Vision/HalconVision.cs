...
namespace JPTCG.Vision
{
    public class HalconVision
    {
        ...
        public WhiteParaList  WhiteDotDetection(string barcode, string modle, HObject ho_Image1, string ImagePath)
        {
            ...
            return HInspection.WhiteDotInspect1(barcode,modle ,ho_Image1, Pixel_MM,ImagePath);
        ...
        {
            return HInspection.BlackDotInspect(barcode,modle,ho_Image1,Pixel_MM,ImagePath);
